...
namespace RPG
{
    public class GridManager : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (topCorner == null) topCorner = GameObject.FindGameObjectWithTag("Top Corner").transform;
            if (bottomCorner == null) bottomCorner = GameObject.FindGameObjectWithTag("Bottom Corner").transform;
